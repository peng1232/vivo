...
<body>
	...
	<div id="content" class="clearfix">
		<div class="neir">
			<div class="nei_top">
				<span>我的购物车</span> <a> 继续购物 <b>></b>
				</a>
			</div>
			<div class="cart_head">
				<table>
					<tr>
						<th class="col_check"><label> <input type="checkbox"
								class="check_input check_sum" /> <span>全部</span>
						</label></th>
			...
			<div class="shop_cart_item">
				<div class="cart_item_info">
					<table>
						<tr>
							<td class="col_check che"><label> <input
									type="checkbox" class="check_input check_item" />
							</label></td>
							<td class="prod-pic"><a href="#">
									<div class="figure">
										<img src="../img/vivo.jpg" />
									</div>
							</a></td>
							<td class="golds_col pro_col"><a href="#" class="golds_link">vivo
									Y78t 8GB+256GB 远山青</a> <br /> <span> 颜色：远山青 </span></td>
							<td class="price_col">1299.00</td>
							<td class="number-box"><a class="reduce-num num_shu">-</a> <span
								class="prod-num">1</span> <a class="add-num num_shu">+</a></td>
							<td class="total_price column">1299.00</td>
							<td class="zaozuo"><a class="favorite" href="#">加入到购物车</a> <br />
							<a href="#">删除</a></td>
						</tr>
					</table>
				</div>
				...
				<div class="cart_item_info">
					<table>
						<tr>
							...
							<td class="price_col">1299.00</td>
							<td class="number-box"><a class="reduce-num num_shu">-</a> <span
								class="prod-num">2</span> <a class="add-num num_shu">+</a></td>
							<td class="total_price column">1299.00</td>
							<td class="zaozuo"><a class="favorite" href="#">加入到购物车</a> <br />
							<a href="#">删除</a></td>
						</tr>
						...
						<div class="cart_toolbar_inner">
							<ul class="clearfix option_list">
								<li><label> <input type="checkbox"
										class="check_input check_sum" /> <span class="quan wei">全选</span>
								</label></li>
								<li><span class="del wei">删除选中的商品</span></li>
								<li><span class="shou wei">移入收藏夹</span></li>
							</ul>
	...
	<div class="message">
		<div class="message_box">
			...
			<div class="message_box_center"></div>
			<div class="message_box_footer"></div>
		</div>
	</div>
