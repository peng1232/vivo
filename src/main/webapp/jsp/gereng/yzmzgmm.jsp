						...
						<form action="" method="post" id="sub">
							...
							<div class="form_item">
								...
								<div class="yzm" id='biyan'>
									...
									<svg t="1710990477581" class="icon y" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5356" width="24" height="24"><path d="M512 204.8C233.984 204.8 51.2 483.84 51.2 483.84S186.368 819.2 512 819.2s460.8-335.36 460.8-335.36S790.016 204.8 512 204.8z m0 502.272A200.192 200.192 0 0 1 307.2 512a200.192 200.192 0 0 1 204.8-195.072A200.192 200.192 0 0 1 716.8 512a200.192 200.192 0 0 1-204.8 195.072zM512 409.6a102.4 102.4 0 1 0 102.4 102.4 102.4 102.4 0 0 0-102.4-102.4z" fill="#d1d1d1" p-id="5357"></path></svg>
								</div>
							</div>
...
<script type="text/javascript">
	$(function(){
		$('.yzm').find('.y').css('display', 'none');
		$('.yzm').click(function() {
			var input = $(this).parent().find('.inp'); // 根据点击的图标选择对应的输入框
