	...
	<div class="body_con">
		<div class="body_left">
			<ul class="body_left_list">
				<li><label> <span>用户管理</span> <i
						class="iconfont iconxiajiantou"></i> <a href="javascript:;"></a>
				</label>
					<ul>
						<li><label> <i class="iconfont iconYYGK"></i> <span>普通用户</span>
							...
							<ul>
								<li><label> <span></span> <i
										class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
								</label></li>
								<li><label> <span></span> <i
										class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
								</label></li>
			...
			<li><label> <span>数据统计图管理</span> <i
					class="iconfont iconxiajiantou"></i> <a href="javascript:;"></a>
			</label>
				<ul>
					<li><label> <i class="iconfont iconYYGK"></i> <span>条形统计图管理</span>
							<i class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
					</label>
						<ul>
							<li><label> <span></span> <i
					...
					<li><label> <i class="iconfont iconYYGK"></i> <span>扇形统计图管理</span>
							<i class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
					</label>
						<ul>
							<li><label> <span></span> <i
					...
					<li><label> <i class="iconfont iconYYGK"></i> <span>折线统计图管理</span>
							<i class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
					</label>
						<ul>
							<li><label> <span></span> <i
			...
			<li><label> <span>商品管理</span> <i
				...
				<ul>
					<li><label> <i class="iconfont iconYYGK"></i> <span>商品信息管理</span>
						...
						<ul>
							<li><label> <span>商品规格管理</span> <i
									class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
							</label></li>
							<li><label> <span>商品分类管理</span> <i
									class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
							</label></li>
							<li><label> <span>商品上，下架管理</span> <i
									class="iconfont iconyoujiantou"></i> <a href="javascript:;"></a>
							</label></li>
						</ul></li>
		...
		<div class="body_right">
			<div class="body_top">
				<div class="body_top_left">
					<svg val="0" t="1706508696745" class="icon" viewBox="0 0 1024 1024"
						version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5061"
						width="32" height="32">
						<path
							...
							p-id="5062" fill="#888888"></path></svg>
				</div>
				<span>后台管理</span>
