 ...
 */
@WebServlet("/jsp/hou/ImageUpdateServlet")
@MultipartConfig
public class ImageUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer image_value_id = Integer.valueOf(request.getParameter("image_id"));
		String image_url_value = request.getParameter("image_url_value");
		if(part!=null) {
			//文件对应的信息
			...
			Product_image p = new Product_image(image_value_id,null,newname+houzui);
			pdao.updateProduct_image(p);
