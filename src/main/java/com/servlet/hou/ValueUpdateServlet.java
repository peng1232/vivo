 ...
 */
@WebServlet("/jsp/hou/ValueUpdateServlet")
public class ValueUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Integer id = Integer.valueOf(request.getParameter("specifications_id"));
		String value = request.getParameter("value");
		Specification_value s = new Specification_value(id, null, value);
		sdao.updateValue(s);
